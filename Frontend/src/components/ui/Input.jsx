...
const Input = ({
  ...
  const inputClasses = `w-full box-border px-4 py-3 bg-[rgba(0,0,0,0.02)] text-[#1f1f1f] border rounded-md focus:outline-none focus:ring-0 disabled:bg-[rgba(0,0,0,0.05)] disabled:text-[rgba(31,31,31,0.5)] disabled:cursor-not-allowed transition-colors duration-200 font-sans text-[0.85rem] ${
    error
