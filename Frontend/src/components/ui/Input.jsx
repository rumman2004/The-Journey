...
const Input = ({
  ...
  const inputClasses = `w-full px-4 py-3 bg-[rgba(23,21,45,0.7)] text-white border rounded-lg shadow-[inset_0_2px_4px_rgba(0,0,0,0.3)] focus:outline-none focus:ring-2 disabled:bg-[rgba(255,255,255,0.05)] disabled:text-twilight-text-muted disabled:cursor-not-allowed transition-all duration-300 ${
    error
